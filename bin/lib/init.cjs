...
function cmdInitExecutePhase(cwd, phase, raw) {
  ...
  const result = {
    // Models
    executor_model: resolveModelInternal(cwd, 'nr-executor'),
    verifier_model: resolveModelInternal(cwd, 'nr-verifier'),
...
function cmdInitPlanPhase(cwd, phase, raw) {
  ...
  const result = {
    // Models
    researcher_model: resolveModelInternal(cwd, 'nr-phase-researcher'),
    planner_model: resolveModelInternal(cwd, 'nr-planner'),
    checker_model: resolveModelInternal(cwd, 'nr-plan-checker'),
...
function cmdInitNewProject(cwd, raw) {
  ...
  const braveKeyFile = path.join(homedir, '.nr', 'brave_api_key');
  ...
  const result = {
    // Models
    researcher_model: resolveModelInternal(cwd, 'nr-project-researcher'),
    synthesizer_model: resolveModelInternal(cwd, 'nr-research-synthesizer'),
    roadmapper_model: resolveModelInternal(cwd, 'nr-roadmapper'),
...
function cmdInitMapCodebase(cwd, raw) {
  ...
  const result = {
    // Models
    mapper_model: resolveModelInternal(cwd, 'nr-codebase-mapper'),
