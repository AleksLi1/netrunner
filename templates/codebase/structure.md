...
[ASCII box-drawing tree of top-level directories with purpose - use tree characters for structure only]
...
│   └── nr/            # NR-specific commands
├── netrunner/         # Skill resources
...
**New Slash Command:**
- Primary code: `commands/nr/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `netrunner/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `netrunner/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/netrunner/workflows/{name}.md`

**New Reference Document:**
- Implementation: `netrunner/references/{name}.md`
