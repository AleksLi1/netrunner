...
project_name: "{{name}}"
created: "{{date}}"
type: "{{BUILD:GREENFIELD|BUILD:BROWNFIELD|FIX:DEBUGGING|OPTIMIZE:REFINEMENT}}"
domain: "{{ml|web|api|systems|general}}"
---
...
1. **Map codebase first** via `/nr:map-codebase`
...
This ensures the brain reads current PROJECT.md context.
